...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>courses/hw3.Rmd at master · bcaffo/courses</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1932484:41F0:17A3EF:54F482E9" name="octolytics-dimension-request_id" /><meta content="8777659" name="octolytics-actor-id" /><meta content="mgestal" name="octolytics-actor-login" /><meta content="decf07a40567749bd571e16eaea47ce0247842a87f2702b2e46e7594c1d179ac" name="octolytics-actor-hash" />
...
<meta content="3OlUyxGl2jdAWFuvr3SV45z35x4wRuKKWrSnqKeV4nSErLWIEt5k+wJhE9y+LScKElwipkvs84O7WsJ2vewGfg==" name="csrf-token" />
...
<ul class="dropdown-menu">
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="wQtnrpOOZNyg5ssoMUIGlb3riTK9+pHrm0PpNBRV/GU3yoI/ngoILCqHuCsAxj52IKxWr0ZiOQQVR+cuAVBrAg==" /></div>
...
<ul class="pagehead-actions">
  ...
  <li>
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Vv2nYXIoXqYg2daRcFPDUJZal7LTpq4WICPAQXwF+X0ev/TGQc02ox1tTvzEnl4d6JQpyi86bcKmeHocqCiA5g==" /></div>    <input id="repository_id" name="repository_id" type="hidden" value="16119553" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/bcaffo/courses/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="o8P8VSJcs23WF2Ko26xHb0zqygErUXytOAzT5idmQ+/Bw7JWQ+Sp54RI42+XctRufUJUHD2wBjivALreviKPzA==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/bcaffo/courses/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="oscxlzwoRTCgqZJA6gZ9BuxmLQtYCvFALVCckqbPAP6X7mmsvdaVAxvCB8U+NKjFeJmFcSMW3Ttz5mNTU/KuGA==" /></div>
      <button
        class="minibutton with-count js-toggler-target"
...
<a href="/bcaffo/courses/blob/33a677070b8961123bf57c7d95d1abd9a595a91e/06_StatisticalInference/homework/hw3.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:f627ad584acc506ac6222e8c0145f5cf -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/bcaffo/courses/blob/devel/06_StatisticalInference/homework/hw3.Rmd"
               data-name="devel"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/bcaffo/courses/blob/gh-pages/06_StatisticalInference/homework/hw3.Rmd"
               data-name="gh-pages"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/bcaffo/courses/blob/master/06_StatisticalInference/homework/hw3.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
  ...
  <div class="commit file-history-tease">
    <div class="file-history-tease-header">
        ...
        <time datetime="2015-01-09T17:18:07Z" is="relative-time">Jan 9, 2015</time>
        <div class="commit-title">
            <a href="/bcaffo/courses/commit/8d875eedd3b19179a117675ed6a90fd128cd0567" class="message" data-pjax="true" title="Commiting changes that I&#39;ve forgotten about">Commiting changes that I've forgotten about</a>
        </div>
    </div>
    ...
    <div class="participation">
      <p class="quickstat">
        <a href="#blob_contributors_box" rel="facebox">
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="bcaffo" href="/bcaffo/courses/commits/master/06_StatisticalInference/homework/hw3.Rmd?author=bcaffo"><img alt="Brian Caffo" class="avatar" data-user="1790075" height="20" src="https://avatars3.githubusercontent.com/u/1790075?v=3&amp;s=40" width="20" /></a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="rthisted" href="/bcaffo/courses/commits/master/06_StatisticalInference/homework/hw3.Rmd?author=rthisted"><img alt="Ronald Thisted" class="avatar" data-user="7493800" height="20" src="https://avatars1.githubusercontent.com/u/7493800?v=3&amp;s=40" width="20" /></a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="TroyOfHelen" href="/bcaffo/courses/commits/master/06_StatisticalInference/homework/hw3.Rmd?author=TroyOfHelen"><img alt="TroyOfHelen" class="avatar" data-user="4314054" height="20" src="https://avatars1.githubusercontent.com/u/4314054?v=3&amp;s=40" width="20" /></a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="mmulchandani" href="/bcaffo/courses/commits/master/06_StatisticalInference/homework/hw3.Rmd?author=mmulchandani"><img alt="mmulchandani" class="avatar" data-user="4593344" height="20" src="https://avatars1.githubusercontent.com/u/4593344?v=3&amp;s=40" width="20" /></a>
  ...
  <div class="file-header">
    ...
    <div class="file-actions">
      <div class="button-group">
        <a href="/bcaffo/courses/raw/master/06_StatisticalInference/homework/hw3.Rmd" class="minibutton " id="raw-url">Raw</a>
          <a href="/bcaffo/courses/blame/master/06_StatisticalInference/homework/hw3.Rmd" class="minibutton js-update-url-with-hash">Blame</a>
        <a href="/bcaffo/courses/commits/master/06_StatisticalInference/homework/hw3.Rmd" class="minibutton " rel="nofollow">History</a>
      </div><!-- /.button-group -->

        <a class="octicon-button tooltipped tooltipped-nw"
           href="github-windows://openRepo/https://github.com/bcaffo/courses?branch=master&amp;filepath=06_StatisticalInference%2Fhomework%2Fhw3.Rmd" aria-label="Open this file in GitHub for Windows">
            <span class="octicon octicon-device-desktop"></span>
        </a>

            <a class="octicon-button tooltipped tooltipped-n js-update-url-with-hash"
               aria-label="Clicking this button will fork this project so you can edit the file"
               href="/bcaffo/courses/edit/master/06_StatisticalInference/homework/hw3.Rmd"
               data-method="post" rel="nofollow"><span class="octicon octicon-pencil"></span></a>

          <a class="octicon-button danger tooltipped tooltipped-s"
             href="/bcaffo/courses/delete/master/06_StatisticalInference/homework/hw3.Rmd"
...
<p><code>r round(min(t.test(mtcars$mpg)$conf.int))</code>
<code>r round(max(t.test(mtcars$mpg)$conf.int))</code></p>
...
<p>*** .explanation
<code>r round(qt(.975, df = 8) * 1 / 3, 2)</code></p>
...
<p><code>r round(min(confint), 1)</code>
<code>r round(max(confint), 1)</code></p>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.06278s from github-fe142-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
